...
preInv_remind_cap("2015", "DEU", te_remind, grade) = remind_cap("2015", "DEU", te_remind, grade) - remind_pm_ts("2015") / 2 * remind_deltaCap("2015", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2015", "DEU", te_remind));
added_remind_cap("2015", "DEU", te_remind, grade) = remind_pm_ts("2015") / 2 * remind_deltaCap("2015", "DEU", te_remind, grade);
...
*# conversion from tr USD 2010/TW to USD2015/MW
...
execute_unload "results_DIETER_y2", report4RM;
