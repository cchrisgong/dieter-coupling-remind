...
=======
earlyRetiCap_reporting("2015", reg, te_remind) = (remind_capEarlyReti("2015", reg, te_remind) - remind_capEarlyReti2("2010", reg, te_remind) ) * remind_cap("2015", reg, te_remind, "1")
                                                                            / (1 - remind_capEarlyReti("2015", reg, te_remind)) ;
...
remind_VRECapFac("wind_on") = sum(grade, remind_pm_dataren("DEU", "nur", grade, "wind") * remind_vm_CapDistr("2015", "DEU", "wind", grade) / remind_cap("2015", "DEU", "wind", "1"));
remind_VRECapFac("Solar") = sum(grade, remind_pm_dataren("DEU", "nur", grade, "spv") * remind_vm_CapDistr("2015", "DEU", "spv", grade) / remind_cap("2015", "DEU", "spv", "1"));
remind_HydroCapFac = sum(grade, remind_pm_dataren("DEU", "nur", grade, "hydro") * remind_vm_CapDistr("2015", "DEU", "hydro", grade) / remind_cap("2015", "DEU", "hydro", "1"));
...
=======
* the prodSe that pre-investment REMIND sees in time step t: prodSe(t) -  pm_ts(t)/2 * prodSe(t) * (vm_deltacap(t)/vm_cap(t))
preInv_remind_prodSe("2015", "DEU", pe_remind, se_remind, te_remind)$(remind_cap("2015", "DEU", te_remind, "1") ne 0 ) = remind_prodSe("2015", "DEU", pe_remind, se_remind, te_remind)
                                                                       - remind_pm_ts("2015") /2 * remind_prodSe("2015", "DEU", pe_remind, se_remind, te_remind)
                                                                       * remind_deltaCap("2015", "DEU", te_remind, "1")
                                                                       /remind_cap("2015", "DEU", te_remind, "1");
>>>>>>> dieter
...
*
=======
P_RES.lo("Solar") = preInv_remind_prodSe("2015", "DEU", "pesol", "seel", "spv") * sm_TWa_2_MWh / ( remind_VRECapFac("Solar") * card(h)) ;
P_RES.lo("Wind_on") = preInv_remind_prodSe("2015", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / (remind_VRECapFac("Wind_on") * card(h)) ;
N_CON.lo("ror") = preInv_remind_prodSe("2015", "DEU", "pehyd", "seel", "hydro") * sm_TWa_2_MWh / (capfac_ror * 8760) ;
...
*                    ) * 1e6, 0.2* SMax(h, d(h)));
*
*N_CON.lo("OCGT_eff") = min(sum(grade, preInv_remind_cap("2015", "DEU", "ngt", grade)) * 1e6, 0.2* SMax(h, d(h)));
*
*      
...
con_fuelprice_reg0("lig",reg) = -remind_fuelcost2("2010",reg,"pecoal") / (-remind_budget2("2010",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg0("hc",reg) = -remind_fuelcost2("2010",reg,"pecoal") / (-remind_budget2("2010",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg0("CCGT",reg) = -remind_fuelcost2("2010",reg,"pegas") / (-remind_budget2("2010",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("bio",reg) = -remind_fuelcost2("2010",reg,"pebiolc") / (-remind_budget2("2010",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("nuc",reg) = -remind_fuelcost2("2010",reg,"peur") / (-remind_budget2("2010",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;

con_fuelprice_reg1("lig",reg) = -remind_fuelcost("2015",reg,"pecoal") / (-remind_budget("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg1("hc",reg) = -remind_fuelcost("2015",reg,"pecoal") / (-remind_budget("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg1("CCGT",reg) = -remind_fuelcost("2015",reg,"pegas") / (-remind_budget("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("bio",reg) = -remind_fuelcost("2015",reg,"pebiolc") / (-remind_budget("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("nuc",reg) = -remind_fuelcost("2015",reg,"peur") / (-remind_budget("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
