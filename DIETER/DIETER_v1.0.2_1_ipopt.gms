...
pe_remind   remind primary energy                    /pegas, pecoal,pewin,pesol, pebiolc, peur/
...
preInv_remind_prodSe("2010", "DEU", pe_remind, se_remind, te_remind)$(remind_cap("2010", "DEU", te_remind, "1") ne 0 ) = remind_prodSe("2010", "DEU", pe_remind, se_remind, te_remind)
                                                                       ...
                                                                       * remind_vm_deltaCap("2010", "DEU", te_remind, "1")
...
preInv_remind_cap("2010", "DEU", te_remind, grade) = remind_cap("2010", "DEU", te_remind, grade) - remind_pm_ts("2010") /2 * remind_vm_deltaCap("2010", "DEU", te_remind, grade);
...
N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2010", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2010$ and 2010$
...
*# conversion from tr USD 2010/TW to USD2010/MW
...
execute_unload "results_DIETER_y1_ipopt", report4RM;

*execute_unload "full_DIETER_y1";
execute_unload "report_DIETER_y1_ipopt", report, report_tech, report_hours, report_tech_hours;
