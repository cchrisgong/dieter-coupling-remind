...
preInv_remind_cap("2040", "DEU", te_remind, grade) = remind_cap("2040", "DEU", te_remind, grade) - remind_pm_ts("2040") /2 * remind_deltaCap("2040", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2040", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2040$ and 2040$
...
*# conversion from tr USD 2040/TW to USD2040/MW
