...
te_remind   remind technonlogy					  /spv, wind, elh2, ngcc, ngccc, ngt, gaschp, bioigcc, biochp, pc,pcc, coalchp, storspv, storwind/
...
*==========
P_RES("Solar") = sum(grade, remind_cap("2030", "DEU", "spv", grade)) * 1e6;
P_RES("Wind_on") = sum(grade, remind_cap("2030", "DEU", "wind", grade)) * 1e6;
P_RES("Wind_off") = 0;
...
N_CON("hc") = sum(grade, remind_cap("2030", "DEU", "pc", grade)*remind_capFac("2030", "DEU", "pc")) * 1e6
                ...
                +sum(grade, remind_cap("2030", "DEU", "coalchp", grade)*remind_capFac("2030", "DEU", "coalchp")) * 1e6;
...
N_CON("CCGT") = sum(grade, remind_cap("2030", "DEU", "ngcc", grade)*remind_capFac("2030", "DEU", "ngcc")) * 1e6
                ...
                + sum(grade, remind_cap("2030", "DEU", "gaschp", grade)*remind_capFac("2030", "DEU", "gaschp")) * 1e6;
...
N_CON("bio") = sum(grade, remind_cap("2030", "DEU", "bioigcc", grade)*remind_capFac("2030", "DEU", "bioigcc")) * 1e6
                +sum(grade, remind_cap("2030", "DEU", "biochp", grade)*remind_capFac("2030", "DEU", "biochp")) * 1e6;
...
*           =L=
*
*phi_AC('2013','DEU',h)* N_DSM_SHIFT(dsm_shift)
*
*;
*
*
...
*           =L=
*
*        1.2 * N_DSM_SHIFT(dsm_shift) -  N_DSM_SHIFT(dsm_shift)* phi_AC('2013','DEU',h)
*;
...
*report("2030", varname, sto) = N_STO_P.l(sto);

execute_unload "results_DIETER_1" ;
