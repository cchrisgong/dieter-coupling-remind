...
preInv_remind_cap("2060", "DEU", te_remind, grade) = remind_cap("2060", "DEU", te_remind, grade) - remind_pm_ts("2060") /2 * remind_deltaCap("2060", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2060", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2060$ and 2060$
...
*# conversion from tr USD 2060/TW to USD2060/MW
