...
preInv_remind_cap("2060", "DEU", te_remind, grade) = remind_cap("2060", "DEU", te_remind, grade) - remind_pm_ts("2060") / 2 * remind_deltaCap("2060", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2060", "DEU", te_remind));
added_remind_cap("2060", "DEU", te_remind, grade) = remind_pm_ts("2060") / 2 * remind_deltaCap("2060", "DEU", te_remind, grade);
...
*# conversion from tr USD 2055/TW to USD2015/MW
...
execute_unload "results_DIETER_y11", report4RM;
