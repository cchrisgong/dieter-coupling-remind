...
preInv_remind_cap("2025", "DEU", te_remind, grade) = remind_cap("2025", "DEU", te_remind, grade) - remind_pm_ts("2025") /2 * remind_deltaCap("2025", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2025", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2025$ and 2025$
...
*# conversion from tr USD 2025/TW to USD2025/MW
