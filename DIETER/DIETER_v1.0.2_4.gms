...
preInv_remind_cap("2025", "DEU", te_remind, grade) = remind_cap("2025", "DEU", te_remind, grade) - remind_pm_ts("2025") / 2 * remind_deltaCap("2025", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2025", "DEU", te_remind));
added_remind_cap("2025", "DEU", te_remind, grade) = remind_pm_ts("2025") / 2 * remind_deltaCap("2025", "DEU", te_remind, grade);
...
*# conversion from tr USD 2020/TW to USD2015/MW
...
execute_unload "results_DIETER_y4", report4RM;
