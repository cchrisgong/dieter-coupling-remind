...
P_RES.lo("Wind_on") = preInv_remind_prodSe("2030", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_on") * 0.805 ;
*AO* 19.5% of wind-based generation in DEU in 2019 is from offshore
P_RES.lo("Wind_off") = preInv_remind_prodSe("2030", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_off") * 0.195;
* Quick workaround: limit wind offshore deployment to +10% of REMIND value
P_RES.up("Wind_off") = preInv_remind_prodSe("2030", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_off") * 0.195 *1.1;
