...
con_fuelprice_reg("lig",reg) = -remind_fuelcost("2030",reg,"pecoal") / (-remind_budget("2030",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg("hc",reg) = -remind_fuelcost("2030",reg,"pecoal") / (-remind_budget("2030",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg("CCGT",reg) = -remind_fuelcost("2030",reg,"pegas") / (-remind_budget("2030",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
