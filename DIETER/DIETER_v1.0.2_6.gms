...
preInv_remind_cap("2035", "DEU", te_remind, grade) = remind_cap("2035", "DEU", te_remind, grade) - remind_pm_ts("2035") / 2 * remind_deltaCap("2035", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2035", "DEU", te_remind));
added_remind_cap("2035", "DEU", te_remind, grade) = remind_pm_ts("2035") / 2 * remind_deltaCap("2035", "DEU", te_remind, grade);
...
*# conversion from tr USD 2030/TW to USD2015/MW
...
execute_unload "results_DIETER_y6", report4RM;
