...
preInv_remind_cap("2035", "DEU", te_remind, grade) = remind_cap("2035", "DEU", te_remind, grade) - remind_pm_ts("2035") /2 * remind_deltaCap("2035", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2035", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2035$ and 2035$
...
*# conversion from tr USD 2035/TW to USD2035/MW
