...
preInv_remind_cap("2070", "DEU", te_remind, grade) = remind_cap("2070", "DEU", te_remind, grade) - remind_pm_ts("2070") /2 * remind_deltaCap("2070", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2070", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2070$ and 2070$
...
*# conversion from tr USD 2070/TW to USD2070/MW
