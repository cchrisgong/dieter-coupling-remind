...
preInv_remind_cap("2100", "DEU", te_remind, grade) = remind_cap("2100", "DEU", te_remind, grade) - remind_pm_ts("2100") /2 * remind_deltaCap("2100", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2100", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2100$ and 2100$
...
*# conversion from tr USD 2100/TW to USD2100/MW
