...
preInv_remind_cap("2020", "DEU", te_remind, grade) = remind_cap("2020", "DEU", te_remind, grade) - remind_pm_ts("2020") /2 * remind_deltaCap("2020", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2020", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2020$ and 2020$
...
*# conversion from tr USD 2020/TW to USD2020/MW
