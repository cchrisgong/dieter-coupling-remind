...
P_RES.lo("Wind_on") = preInv_remind_prodSe("2020", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_on") * 0.805 ;
*AO* 19.5% of wind-based generation in DEU in 2019 is from offshore
P_RES.lo("Wind_off") = preInv_remind_prodSe("2020", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_off") * 0.195;
* Quick workaround: limit wind offshore deployment to +10% of REMIND value
P_RES.up("Wind_off") = preInv_remind_prodSe("2020", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_off") * 0.195 *1.1;
...
preInv_remind_cap("2020", "DEU", te_remind, grade) = remind_cap("2020", "DEU", te_remind, grade) - remind_pm_ts("2020") / 2 * remind_deltaCap("2020", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2020", "DEU", te_remind));
added_remind_cap("2020", "DEU", te_remind, grade) = remind_pm_ts("2020") / 2 * remind_deltaCap("2020", "DEU", te_remind, grade);
...
con_fuelprice_reg("lig",reg) = -remind_fuelcost("2020",reg,"pecoal") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg("hc",reg) = -remind_fuelcost("2020",reg,"pecoal") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg("CCGT",reg) = -remind_fuelcost("2020",reg,"pegas") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("OCGT_eff",reg) = con_fuelprice_reg("CCGT",reg);
con_fuelprice_reg("bio",reg) = -remind_fuelcost("2020",reg,"pebiolc") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("nuc",reg) = -remind_fuelcost("2020",reg,"peur") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
...
*# conversion from tr USD 2015/TW to USD2015/MW
...
execute_unload "results_DIETER_y3", report4RM;
