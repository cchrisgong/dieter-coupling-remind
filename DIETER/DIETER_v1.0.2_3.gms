...
totFixedLoad = remind_totdemand("2020", "DEU", "seel") * sm_TWa_2_MWh;
*totFlexLoad = remind_totdemand("2020", "DEU", "seel") * sm_TWa_2_MWh * (1 - P);
...
=======
earlyRetiCap_reporting("2020", reg, te_remind) = (remind_capEarlyReti("2020", reg, te_remind) - remind_capEarlyReti2("2015", reg, te_remind) ) * remind_cap("2020", reg, te_remind, "1")
                                                                            / (1 - remind_capEarlyReti("2020", reg, te_remind)) ;
...
remind_VRECapFac("wind_on") = sum(grade, remind_pm_dataren("DEU", "nur", grade, "wind") * remind_vm_CapDistr("2020", "DEU", "wind", grade) / remind_cap("2020", "DEU", "wind", "1"));
remind_VRECapFac("Solar") = sum(grade, remind_pm_dataren("DEU", "nur", grade, "spv") * remind_vm_CapDistr("2020", "DEU", "spv", grade) / remind_cap("2020", "DEU", "spv", "1"));
...
=======
* the prodSe that pre-investment REMIND sees in time step t: prodSe(t) -  pm_ts(t)/2 * prodSe(t) * (vm_deltacap(t)/vm_cap(t))
preInv_remind_prodSe("2020", "DEU", pe_remind, se_remind, te_remind)$(remind_cap("2020", "DEU", te_remind, "1") ne 0 ) = remind_prodSe("2020", "DEU", pe_remind, se_remind, te_remind)
                                                                       - remind_pm_ts("2020") /2 * remind_prodSe("2020", "DEU", pe_remind, se_remind, te_remind)
                                                                       * remind_deltaCap("2020", "DEU", te_remind, "1")
                                                                       /remind_cap("2020", "DEU", te_remind, "1");
>>>>>>> dieter
...
<<<<<<< HEAD
*P_RES.lo("Solar") = preInv_remind_prodSe("2020", "DEU", "pesol", "seel", "spv") * sm_TWa_2_MWh / capfac_const("Solar") ;
*P_RES.lo("Wind_on") = preInv_remind_prodSe("2020", "DEU", "pewin", "seel", "wind") * sm_TWa_2_MWh / capfac_const("Wind_on") ;
...
*                    ) * 1e6, 0.2* SMax(h, d(h)));
*
*N_CON.lo("OCGT_eff") = min(sum(grade, preInv_remind_cap("2020", "DEU", "ngt", grade)) * 1e6, 0.2* SMax(h, d(h)));
*
*      
...
*1.2 is the conversion btw 2015$ and 2015$
...
con_fuelprice_reg0("lig",reg) = -remind_fuelcost2("2015",reg,"pecoal") / (-remind_budget2("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg0("hc",reg) = -remind_fuelcost2("2015",reg,"pecoal") / (-remind_budget2("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg0("CCGT",reg) = -remind_fuelcost2("2015",reg,"pegas") / (-remind_budget2("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("bio",reg) = -remind_fuelcost2("2015",reg,"pebiolc") / (-remind_budget2("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("nuc",reg) = -remind_fuelcost2("2015",reg,"peur") / (-remind_budget2("2015",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;

con_fuelprice_reg1("lig",reg) = -remind_fuelcost("2020",reg,"pecoal") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg1("hc",reg) = -remind_fuelcost("2020",reg,"pecoal") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg1("CCGT",reg) = -remind_fuelcost("2020",reg,"pegas") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("bio",reg) = -remind_fuelcost("2020",reg,"pebiolc") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("nuc",reg) = -remind_fuelcost("2020",reg,"peur") / (-remind_budget("2020",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
...
cdata("eta_con","lig") = remind_eta1("2020","DEU","pc");
cdata("eta_con","hc") = remind_eta1("2020","DEU","pc") * 0.92;
cdata("eta_con","CCGT") = remind_eta1("2020","DEU","ngcc");
cdata("eta_con","OCGT_eff") = remind_eta1("2020","DEU","ngt");
cdata("eta_con","bio") = remind_eta1("2020","DEU","bioigcc");
cdata("eta_con","ror") = remind_eta2("2020","DEU","hydro");
cdata("eta_con","nuc") = remind_eta2("2020","DEU","tnrs");
...
c_i_ovnt("CCGT") = remind_CapCost("2020", "DEU", "ngcc")  * 1e6 * 1.2;
c_i_ovnt("OCGT_eff") = remind_CapCost("2020", "DEU", "ngt") * 1e6 * 1.2;
c_i_ovnt("bio") = remind_CapCost("2020", "DEU", "biochp") * 1e6 * 1.2;
c_i_ovnt("ror") = remind_CapCost("2020", "DEU", "hydro") * 1e6 * 1.2;
c_i_ovnt("nuc") = remind_CapCost("2020", "DEU", "tnrs") * 1e6 * 1.2;
...
execute_unload "results_DIETER_y3", report4RM, reportmk_4RM;

execute_unload "full_DIETER_y3";
execute_unload "report_DIETER_y3", report, report_tech, report_hours, report_tech_hours;
