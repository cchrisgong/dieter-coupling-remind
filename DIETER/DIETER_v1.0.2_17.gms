...
*                    ) * 1e6, 0.2* SMax(h, d(h)));
*
*N_CON.lo("OCGT_eff") = min(sum(grade, preInv_remind_cap("2130", "DEU", "ngt", grade)) * 1e6, 0.2* SMax(h, d(h)));
*
*      
...
con_fuelprice_reg0("lig",reg) = -remind_fuelcost2("2110",reg,"pecoal") / (-remind_budget2("2110",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg0("hc",reg) = -remind_fuelcost2("2110",reg,"pecoal") / (-remind_budget2("2110",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg0("CCGT",reg) = -remind_fuelcost2("2110",reg,"pegas") / (-remind_budget2("2110",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("bio",reg) = -remind_fuelcost2("2110",reg,"pebiolc") / (-remind_budget2("2110",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg0("nuc",reg) = -remind_fuelcost2("2110",reg,"peur") / (-remind_budget2("2110",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;

con_fuelprice_reg1("lig",reg) = -remind_fuelcost("2130",reg,"pecoal") / (-remind_budget("2130",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg1("hc",reg) = -remind_fuelcost("2130",reg,"pecoal") / (-remind_budget("2130",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg1("CCGT",reg) = -remind_fuelcost("2130",reg,"pegas") / (-remind_budget("2130",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("bio",reg) = -remind_fuelcost("2130",reg,"pebiolc") / (-remind_budget("2130",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg1("nuc",reg) = -remind_fuelcost("2130",reg,"peur") / (-remind_budget("2130",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
