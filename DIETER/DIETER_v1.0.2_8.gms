...
N_CON.lo("OCGT_eff") = sum(grade, preInv_remind_cap("2045", "DEU", "ngt", grade)) * 1e6;
...
con_fuelprice_reg("lig",reg) = -remind_fuelcost("2045",reg,"pecoal") / (-remind_budget("2045",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg("hc",reg) = -remind_fuelcost("2045",reg,"pecoal") / (-remind_budget("2045",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg("CCGT",reg) = -remind_fuelcost("2045",reg,"pegas") / (-remind_budget("2045",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("OCGT_eff",reg) = con_fuelprice_reg("CCGT",reg);
con_fuelprice_reg("bio",reg) = -remind_fuelcost("2045",reg,"pebiolc") / (-remind_budget("2045",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("nuc",reg) = -remind_fuelcost("2045",reg,"peur") / (-remind_budget("2045",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
