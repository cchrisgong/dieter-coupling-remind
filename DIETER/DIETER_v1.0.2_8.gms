...
preInv_remind_cap("2045", "DEU", te_remind, grade) = remind_cap("2045", "DEU", te_remind, grade) - remind_pm_ts("2045") /2 * remind_deltaCap("2045", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2045", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2045$ and 2045$
...
*# conversion from tr USD 2045/TW to USD2045/MW
