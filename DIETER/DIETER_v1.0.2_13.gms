...
preInv_remind_cap("2080", "DEU", te_remind, grade) = remind_cap("2080", "DEU", te_remind, grade) - remind_pm_ts("2080") /2 * remind_deltaCap("2080", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2080", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2080$ and 2080$
...
*# conversion from tr USD 2080/TW to USD2080/MW
