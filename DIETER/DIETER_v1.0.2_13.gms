...
N_CON.lo("OCGT_eff") = sum(grade, preInv_remind_cap("2080", "DEU", "ngt", grade)) * 1e6;
...
con_fuelprice_reg("lig",reg) = -remind_fuelcost("2080",reg,"pecoal") / (-remind_budget("2080",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 - 3.6;
con_fuelprice_reg("hc",reg) = -remind_fuelcost("2080",reg,"pecoal") / (-remind_budget("2080",reg)) * 1e12 / sm_TWa_2_MWh * 1.2 + 1.8;
con_fuelprice_reg("CCGT",reg) = -remind_fuelcost("2080",reg,"pegas") / (-remind_budget("2080",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("OCGT_eff",reg) = con_fuelprice_reg("CCGT",reg);
con_fuelprice_reg("bio",reg) = -remind_fuelcost("2080",reg,"pebiolc") / (-remind_budget("2080",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
con_fuelprice_reg("nuc",reg) = -remind_fuelcost("2080",reg,"peur") / (-remind_budget("2080",reg)) * 1e12 / sm_TWa_2_MWh * 1.2;
