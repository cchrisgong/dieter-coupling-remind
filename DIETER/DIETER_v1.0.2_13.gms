...
preInv_remind_cap("2080", "DEU", te_remind, grade) = remind_cap("2080", "DEU", te_remind, grade) - remind_pm_ts("2080") / 2 * remind_deltaCap("2080", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2080", "DEU", te_remind));
added_remind_cap("2080", "DEU", te_remind, grade) = remind_pm_ts("2080") / 2 * remind_deltaCap("2080", "DEU", te_remind, grade);
...
*# conversion from tr USD 2070/TW to USD2015/MW
...
execute_unload "results_DIETER_y13", report4RM;
