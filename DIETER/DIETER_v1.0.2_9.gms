...
preInv_remind_cap("2050", "DEU", te_remind, grade) = remind_cap("2050", "DEU", te_remind, grade) - remind_pm_ts("2050") /2 * remind_deltaCap("2050", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2050", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2050$ and 2050$
...
*# conversion from tr USD 2050/TW to USD2050/MW
