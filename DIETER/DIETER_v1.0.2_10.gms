...
preInv_remind_cap("2055", "DEU", te_remind, grade) = remind_cap("2055", "DEU", te_remind, grade) - remind_pm_ts("2055") /2 * remind_deltaCap("2055", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2055", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2055$ and 2055$
...
*# conversion from tr USD 2055/TW to USD2055/MW
