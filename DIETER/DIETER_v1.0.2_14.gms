...
preInv_remind_cap("2090", "DEU", te_remind, grade) = remind_cap("2090", "DEU", te_remind, grade) - remind_pm_ts("2090") / 2 * remind_deltaCap("2090", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2090", "DEU", te_remind));
added_remind_cap("2090", "DEU", te_remind, grade) = remind_pm_ts("2090") / 2 * remind_deltaCap("2090", "DEU", te_remind, grade);
...
*# conversion from tr USD 2080/TW to USD2015/MW
...
execute_unload "results_DIETER_y14", report4RM;
