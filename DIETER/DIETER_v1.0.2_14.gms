...
preInv_remind_cap("2090", "DEU", te_remind, grade) = remind_cap("2090", "DEU", te_remind, grade) - remind_pm_ts("2090") /2 * remind_deltaCap("2090", "DEU", te_remind, grade);
...
*N_CON.lo("ror") = sum(  grade, preInv_remind_cap("2090", "DEU", "hydro", grade)  ) * 1e6;
...
*1.2 is the conversion btw 2090$ and 2090$
...
*# conversion from tr USD 2090/TW to USD2090/MW
