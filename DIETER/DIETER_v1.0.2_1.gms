...
preInv_remind_prodSe("2010", "DEU", pe_remind, se_remind, te_remind)$(remind_cap("2010", "DEU", te_remind, "1") ne 0 ) = remind_prodSe("2010", "DEU", pe_remind, se_remind, te_remind)
                                                                       - remind_pm_ts("2010") /2 * remind_prodSe("2010", "DEU", pe_remind, se_remind, te_remind)
                                                                       * remind_deltaCap("2010", "DEU", te_remind, "1")
                                                                       /remind_cap("2010", "DEU", te_remind, "1");
...
preInv_remind_cap("2010", "DEU", te_remind, grade) = remind_cap("2010", "DEU", te_remind, grade) - remind_pm_ts("2010") / 2 * remind_deltaCap("2010", "DEU", te_remind, grade) * (1 - remind_capEarlyReti("2010", "DEU", te_remind));
added_remind_cap("2010", "DEU", te_remind, grade) = remind_pm_ts("2010") / 2 * remind_deltaCap("2010", "DEU", te_remind, grade);
...
*# conversion from tr USD 2005/TW to USD2015/MW
...
execute_unload "results_DIETER_y1", report4RM;
